...
- Baseline PWA/offline completata: Chart.js locale, prima release `releases/v2026.05.30/` scoped, release consigliata corrente `releases/v2026.07.14/`, launcher offline `/stable/`, finestra versioni e verifica Android del maintainer sulla baseline.
