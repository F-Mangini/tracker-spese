...
I workaround mobile su focus, picker nativi, selection cleanup, viewport e tastiera sono isolati nei moduli modale/mobile e vanno trattati con cautela. Quando un dropdown ricercabile passa in modalita scrittura, la modale ritenta lo scroll e lo ripete sui resize della viewport per mantenere visibile la tendina sopra la tastiera; lo scroll interno della modale viene usato prima di ricorrere allo scroll della pagina.
