...
- Le cache offline versionate esistono in cartelle release immutabili, oggi `releases/v2026.05.30/`, `releases/v2026.06.03/` e `releases/v2026.06.12/`; ogni nuova release richiede una nuova cartella e un nuovo cache namespace.
