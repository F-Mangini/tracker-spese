...
Copre i primi guardrail su storage, cache letture spese, query filtri/statistiche/riepiloghi, parser base e importi ambigui, azioni spesa, controller input rapido, controller barra input mobile, navigazione, filtri/controller filtri, timeline/controller timeline, aggregazioni/controller statistiche, helper/rendering UI estratti, configurazione grafici, decisioni/controller stack UI/back button, cleanup DOM collegati al popstate, lifecycle/form/dropdown/tag/focus mobile della modale, flussi/controller impostazioni, tema, toast e dialog conferma. I prossimi test ad alto valore riguardano history/back button reale, tastiera mobile su device e interazioni DOM complesse.
