...
Copre i primi guardrail su storage, parser base e importi ambigui, azioni spesa, controller input rapido, navigazione, filtri/controller filtri, timeline/controller timeline, aggregazioni/controller statistiche, helper/rendering UI estratti, configurazione grafici, decisioni/controller stack UI/back button, cleanup DOM collegati al popstate, form/dropdown/tag della modale, flussi/controller impostazioni, tema, toast e dialog conferma. I prossimi test ad alto valore riguardano history/back button reale, modali, tastiera mobile e interazioni DOM complesse.
