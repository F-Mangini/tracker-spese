...
const CATEGORIES = [
    { id: 'abbigliamento', nome: 'Abbigliamento', emoji: '👕', keywords: ['maglietta', 'maglia', 'maglione', 'pantaloni', 'scarpe', 'stivali', 'giacca', 'vestito', 'zara', 'h&m', 'nike', 'adidas', 'felpa', 'jeans', 'camicia', 'cappotto', 'calze', 'intimo', 'gonna', 'top', 'cappello', 'sciarpa', 'guanti', 'body', 'pantaloncini', 'shorts', 'mutande', 'reggiseno', 'boxer', 'slip', 'calzini', 'collant', 'cravatta', 'blazer', 'costume', 't-shirt', 'corsetto', 'coprispalla'] },
    ...
    { id: 'bar', nome: 'Bar', emoji: '☕', keywords: ['caffè', 'caffe', 'acqua', 'cappuccino', 'cornetto', 'brioche', 'brioches', 'espresso', 'bar', 'colazione', 'latte', 'tè', 'the', 'thè', 'gelato', 'biscotto', 'pasticciotto', 'granita', 'espressino', 'cioccolata', 'ginseng', 'crepes', 'waffle', 'yogurt', 'torta', 'coca cola', 'focaccia'] },
    ...
    { id: 'drink', nome: 'Drink', emoji: '🍺', keywords: ['birra', 'vino', 'cocktail', 'aperitivo', 'spritz', 'drink', 'shot', 'mojito', 'gin', 'rum', 'vodka', 'amaro', 'negroni', 'campari', 'camparino', 'limoncello'] },
    { id: 'formazione', nome: 'Formazione', emoji: '🎓', keywords: ['libro', 'corso', 'università', 'scuola', 'master', 'udemy', 'lezione', 'formazione', 'workshop', 'certificazione'] },
    { id: 'intrattenimento', nome: 'Intrattenimento', emoji: '🎬', keywords: ['cinema', 'netflix', 'spotify', 'disney', 'prime video', 'concerto', 'teatro', 'museo', 'mostra', 'evento', 'playstation', 'xbox', 'nintendo', 'gioco', 'videogioco', 'steam', 'bowling', 'biliardo', 'ice hockey', 'biliardino', 'sala giochi', 'spettacolo', 'pungiball'] },
    ...
    { id: 'regali', nome: 'Regali', emoji: '🎁', keywords: ['regalo', 'fiori', 'pensiero', 'compleanno', 'natale', 'anniversario', 'san valentino'] },
    ...
    { id: 'salute', nome: 'Salute', emoji: '💊', keywords: ['farmacia', 'medicina', 'dottore', 'medico', 'dentista', 'visita', 'analisi', 'ospedale', 'ottico', 'occhiali', 'integratore', 'integratori', 'vitamina', 'vitamine', 'cerotti', 'psicologo', 'psicologa'] },
    ...
    { id: 'telefono', nome: 'Telefono', emoji: '📱', keywords: ['ricarica', 'iliad', 'vodafone', 'tim', 'wind', 'ho mobile', 'fastweb', 'sim'] },
